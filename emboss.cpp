...
void emboss(Mat img){
	...
	createTrackbar("size","image",nullptr,8,nothing);
	setTrackbarPos("size","image",slider);

	createTrackbar("0 : BL n1 : BR n2 : TR n3 : BR","image",nullptr,3,nothing);
	setTrackbarPos("size","image",slider2);
